    ...
    return (
      <section className="mx-auto max-w-2xl px-5 py-16 lg:px-8">
        <div className="rounded-3xl border border-forest-900/10 bg-white p-8 text-center shadow-soft">
          ...
          <h1 className="mt-5 text-3xl font-bold">Cancellation request submitted.</h1>
          <p className="mt-3 leading-7 text-forest-900/60">The backend will ultimately determine the cancellation result, refund, and released room inventory.</p>
  ...
  return (
    <section className="mx-auto max-w-2xl px-5 py-12 lg:px-8">
      ...
      <div className="rounded-3xl border border-forest-900/10 bg-white p-6 shadow-soft">
        ...
        <h1 className="mt-2 text-3xl font-bold">Request cancellation</h1>
        <p className="mt-3 text-sm leading-6 text-forest-900/60">
          Cancelling may affect your refund based on the rate and cancellation policy attached to your reservation.
        </p>
